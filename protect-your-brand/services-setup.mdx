...
description: "Configure ChainPatrol services like detection, monitoring, reviewing, wallet blocking, and automated takedowns for your organization's brand protection."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Wallet Blocking" icon="wallet" color="#ef4444">
    Real-time blocklist distribution to wallets and partner platforms
  </Card>
...
<Tabs>
  <Tab title="What It Does" icon="info">
    Approved threats are added to ChainPatrol's global blocklist, which is distributed to partner wallets, browsers, and security platforms — including major cryptocurrency wallets like Coinbase Wallet and MetaMask. This prevents users from interacting with malicious addresses, domains, or contracts in real-time, and is one of several distribution channels ChainPatrol uses alongside browser and DNS-level blocking.
  </Tab>
  
  <Tab title="Who Needs It" icon="users">
    **Ideal for:**
    - Brands across Fintech, Banking, Crypto, iGaming, VC, and more whose users interact with digital wallets or blockchain-connected products
    - Cryptocurrency projects and protocols
    - DeFi platforms
    - NFT projects
    - Organizations with blockchain-related threats
  </Tab>
