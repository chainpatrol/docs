...
description: "Configure ChainPatrol services like detection, monitoring, reviewing, blocklisting, automated takedowns, and Dark Web Monitoring for your organization's brand protection."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Blocklisting" icon="ban" color="#ef4444">
    Real-time blocklist distribution to browsers, wallets, and partner platforms
  </Card>
  ...
  <Card title="Dark Web Monitoring" icon="user-secret" color="#6366f1">
...
<Tabs>
  ...
  <Tab title="When to Enable" icon="calendar">
    **Prerequisites:**
    ...
    - Enable before Blocklisting if you want approval control
  </Tab>
...
<Tabs>
  <Tab title="What It Does" icon="info">
    Approved threats are added to ChainPatrol's global blocklist, which is distributed in real time to partner browsers, DNS providers, and security platforms — including Google Safe Browsing, Quad9, and VirusTotal — as well as crypto wallets like Coinbase Wallet and MetaMask. This prevents users from interacting with malicious domains, addresses, or contracts before they get hurt.
  </Tab>
  
  <Tab title="Who Needs It" icon="users">
    **Ideal for:**
    - Any brand across Fintech, Banking, Crypto, iGaming, VC, and more that wants its confirmed threats blocked in browsers, DNS resolvers, and antivirus tools automatically
    - Organizations whose users also interact with crypto wallets or blockchain-connected products
    - Cryptocurrency projects, protocols, DeFi platforms, and NFT projects
  </Tab>
  ...
  <Tab title="Requirements" icon="list-check">
    ...
    **Required Legal Docs:**
    ...
    <Warning>
    **Important:** Enabling Blocklisting has immediate impact on end-users. Organizations must verify their asset configuration is accurate before enabling this service.
    </Warning>
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Who Needs It" icon="users">
    **Ideal for:**
    ...
    - Brands in high-risk industries (Fintech, Banking, iGaming, Crypto, e-commerce)
  </Tab>
...
<Tabs>
  <Tab title="What It Does" icon="info">
    Dark Web Monitoring lets organization owners and admins look up leaked credentials for allowlisted brands, using the email domains and addresses you already track. Results are masked in the session. A daily Slack alert fires when leak volume for a monitored domain increases. ChainPatrol does not store leak contents.

    See the [Dark Web Monitoring](/concepts/dark-web-monitoring) concept for how search, acknowledgement, and alerts work.
  </Tab>
  
  <Tab title="Who Needs It" icon="users">
    **Ideal for:**
    - Financial and fintech organizations monitoring employee and brand email credentials
    - Teams that need an on-demand investigation tool rather than a stored detections inbox
    - Organizations already tracking EMAIL assets on their brands
  </Tab>
  
  <Tab title="When to Enable" icon="calendar">
    **Prerequisites:**
    - Organization profile complete, with brands and EMAIL assets defined
    - Slack connected if you want leak-count alerts
    - Account team (or ChainPatrol staff) to turn the service on and select which brands are searchable
  </Tab>
  
  <Tab title="Requirements" icon="list-check">
    **Required Approvals:**
    - ChainPatrol account team enables the service and brand allowlist
...
<Steps>
  ...
  <Step title="ChainPatrol Review">
    **For certain services:**
    ...
    - Security team validates configuration for Blocklisting
  </Step>
</Steps>
...
| Blocklisting | None (but verification required) | - |
...
flowchart TD
    ...
    Reviewing --> Blocklisting[Blocklisting]
    ...
    style Blocklisting fill:#ef4444
