...
The LinkedIn monitoring service now uses automated detection to protect your brand on LinkedIn.

- **Automated Employee Protection:** Non‑whitelisted LinkedIn profiles that impersonate your employees are automatically reported.
- **Automated Post Monitoring:** Public LinkedIn posts are scanned for hiring‑related scams and other phishing threats using keyword‑based detection.

Enable this service to receive real‑time alerts and automated takedown submissions for LinkedIn threats. (Previously, LinkedIn monitoring relied on manual reporting; it is now fully automated.)
