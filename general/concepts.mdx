...
Dark Web Monitoring lives under **Employee Protection → Dark Web**. For now, it supports searching leaked credentials for your brands, with alerts when new leaks appear. See [Dark Web Monitoring](/concepts/dark-web-monitoring).