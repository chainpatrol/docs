...
icon: lightbulb
title: Concepts
description: Learn core ChainPatrol concepts including assets, asset status (allowed, blocked, unknown), detections, reports, proposals, reviews, takedowns, and Dark Web Monitoring.
---

## Assets

On ChainPatrol, we track digital assets like URLs, domains, social profiles, apps, and — for crypto-related brands — contract or wallet addresses.
...
- **Reviewed**: All of the proposals in the report have been reviewed (the underlying status is `CLOSED`)

Reports are grouped by their status in the admin dashboard to make it easier to manage. To Do reports are split across two tabs: **ChainPatrol Review** for reports awaiting ChainPatrol's team, and **Customer Confirmation** for reports escalated to your organization for approval.
...
Dark Web Monitoring lives under **Employee Protection → Dark Web**. It supports searching dark web leak data against your brands' tracked email domains, email addresses, and crypto wallet addresses, with alerts when new leaks appear. See [Dark Web Monitoring](/concepts/dark-web-monitoring).