...
description: Create and use ChainPatrol API keys — including organization vs. user and test vs. live keys — to authenticate requests to our threat detection APIs.
---
