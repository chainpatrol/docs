---
title: ChainPatrol Discord Bot (BETA)
sidebarTitle: Discord Bot
description: A Discord bot that can be used submit scam reports to ChainPatrol
---

<Warning>
  This is a beta feature. If you have any feedback or suggestions, please let us
  know in our [Discord server](https://chainpatrol.io/discord).
</Warning>
...
Then, you need to configure the bot to send reports to your admin dashboard. Right now,
...
for you on ChainPatrol and link it to your Discord server. Then, you can use the
`/report` command to submit scam reports.
