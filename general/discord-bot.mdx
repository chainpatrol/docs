...
You can create a feed channel of scam reports submitted by your server members. To do this,
create a new channel on your Discord server and name it something like `chainpatrol-reports`. This is where the
bot will post messages when a new scam report is submitted. Then, you can use the following command
to link the channel to your ChainPatrol organization:
...
![Example of the feed channel](/images/discord-bot-prompt.png)
