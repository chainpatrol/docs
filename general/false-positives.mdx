...
icon: "gavel"
description: "Learn how ChainPatrol handles false positive reports with human-in-the-loop review and how to submit a dispute for an incorrectly blocked URL or address."
---

## Report

<Card
  title="Report a False Postive"
  icon="gavel"
  href="https://app.chainpatrol.io/dispute"
>
...
whether its coming from a project owner, an automated scan, or from community submission.
...
If there's a legal issue involved, you can reach us directly at [disputes@chainpatrol.io](mailto:disputes@chainpatrol.io).
