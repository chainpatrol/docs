---
title: Address
description: Report a wallet address or smart contract address as a ChainPatrol asset, normalized to lowercase and detected via the 0x prefix and 20-byte length.
---
