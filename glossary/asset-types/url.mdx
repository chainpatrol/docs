---
title: URL
description: Report a domain or subdomain as a URL asset in ChainPatrol — normalized to lowercase punycode so blocking one domain also covers all of its subdomains.
---
