...
4. Find the Vercel section and click "Connect"

### 2. Authorize with Vercel

When you click connect, you'll be redirected to Vercel where you'll need to:

1. Select the Vercel team you want to connect
2. Review the permissions ChainPatrol is requesting
3. Click "Allow Access" to authorize the connection
...
- Your Vercel team name listed as connected in the integrations page
- If you came from the Vercel marketplace, you'll be redirected back to Vercel

## What to Expect After Connecting

Once connected, ChainPatrol will:

- Automatically check your Vercel deployments for impersonation attempts
- Alert you of any potential impersonation attempts
...
1. Going back to the Integrations page
2. Finding the Vercel section
3. Clicking "Disconnect"
