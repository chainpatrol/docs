...
To allow the user to continue, listen for the `CHAINPATROL_CONTINUE_AT_OWN_RISK` message in your background script
...
Then you can update your code to first check if the URL is in the ignore list:
