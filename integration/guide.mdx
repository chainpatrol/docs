...
description: Step-by-step guide for wallet developers to integrate the ChainPatrol API, detect malicious websites, and warn users about phishing before transactions.
---
