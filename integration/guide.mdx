...
description: "Step-by-step guide for wallet and app developers to integrate the ChainPatrol API, detect malicious websites, and warn users about phishing threats."
---
