...
description: Step-by-step guide for wallet developers to integrate the ChainPatrol API, detect malicious websites, and warn users about phishing before transactions (or any app that wants to warn users before they interact with malicious sites).
---
