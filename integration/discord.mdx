...
description: Install the ChainPatrol Discord bot to let members report scam URLs, monitor channels for phishing links, and stream blocklist reports to a feed channel.
---
...
For more information, please read ChainPatrol's [privacy policy](https://chainpatrol.com/legal/privacy).
