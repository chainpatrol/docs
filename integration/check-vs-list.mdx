...
description: Compare ChainPatrol's Asset Check and Asset List API endpoints to choose the right approach for wallet URL lookups, blocklist syncing, and privacy.
---
