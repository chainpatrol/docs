...
icon: webhook
title: Webhooks
description: Use ChainPatrol webhooks to receive real-time asset status and blocklist updates, verify signatures, and keep your wallet or SecOps pipeline in sync.
---
