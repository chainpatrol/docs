...
icon: bolt-lightning
title: Zapier
description: Use the ChainPatrol Zapier app to automate scam URL reports from Discord, Slack, or Google Forms and push malicious links straight to the blocklist.
---

# ChainPatrol Zapier App Guide

<Note>
For all new automation projects, **n8n should be preferred over Zapier**.
</Note>
