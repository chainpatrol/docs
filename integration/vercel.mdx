...
icon: triangle
title: Vercel
description: Connect Vercel to ChainPatrol to verify legitimate deployments, reduce false positives, and accelerate takedowns of scam sites impersonating your team.
---
...
ChainPatrol's Vercel integration confirms which Vercel deployments belong to your organization's Vercel team. This helps reduce false positives and enables faster, more accurate reviewing of suspicious Vercel subdomains — separating legitimate deployments from fake ones being used by scammers.

<Note>ChainPatrol also maintains a direct relationship with Vercel's security and trust & safety teams, including a takedown API integration, allowing for accelerated removal of confirmed malicious deployments.</Note>
