...
description: Add the ChainPatrol Telegram bot to your group to submit scam URL reports, run auto-link monitoring, and warn members about phishing links in real time.
---
