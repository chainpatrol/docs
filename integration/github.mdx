...
icon: github
title: GitHub
description: Install the ChainPatrol GitHub App to monitor pull requests, issues, and discussions for scam links and shield your open-source community from phishing.
---
...
Visit the [ChainPatrol GitHub App's Public Page](https://github.com/apps/chainpatrol):
...
<Warning>
  **Important**: Please ensure that all your public repositories are also added
  to your organization assets in **Dashboard > Settings > Organization Assets**
  for complete protection coverage.
</Warning>
