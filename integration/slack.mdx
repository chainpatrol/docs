...
title: Slack Bot
sidebarTitle: Slack
description: Add the ChainPatrol Slack bot to submit scam URL reports, configure threats feed notifications, and receive real-time blocklist alerts in your workspace.
---
...
If [Dark Web Monitoring](/concepts/dark-web-monitoring) is enabled, increased-leak alerts for a monitored email domain are also posted to your organization's configured Slack channel. That alert is separate from the report and blocklist notification toggles above.
