...
If [Dark Web Monitoring](/concepts/dark-web-monitoring) is enabled, leak-count increases for a monitored email domain are also posted to your organization's configured Slack channel. That alert is separate from the report and blocklist notification toggles above.
