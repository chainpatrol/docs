...
description: Learn how to proxy ChainPatrol API requests via Cloudflare Workers or Deno Deploy to hide your API key and preserve user privacy on asset check calls.
---
