---
title: Overview
description: The Relay class passes ChainPatrol warning-page events between the warning page, content script, and background script of your browser extension wallet.
---
