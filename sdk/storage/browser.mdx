---
title: Browser
description: The Storage.browser() adapter caches ThreatDetector URL lookups in the browser's localStorage, ideal for dApps and other web apps running in a standard web page context.
---
