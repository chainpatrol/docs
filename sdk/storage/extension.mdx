---
title: Extension
description: "The Storage.extension() adapter caches ThreatDetector results using the extension storage API for Chrome, Firefox, and Edge browser extensions."
---
