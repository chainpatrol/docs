---
title: Extension
description: The Storage.extension() adapter caches ThreatDetector results using the browser extension storage API for Chrome, Firefox, and Edge wallet extensions.
---
