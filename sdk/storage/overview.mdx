---
title: "Storage Adapters for ThreatDetector Caching"
description: Storage adapters cache ThreatDetector URL lookups to reduce ChainPatrol API calls, with browser localStorage, extension storage, and memory options.
---
