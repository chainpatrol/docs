---
title: Memory
description: The Storage.memory() adapter is the default in-memory cache for ThreatDetector, useful for testing and development where persistence isn't required.
---
