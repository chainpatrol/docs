---
title: "ChainPatrol JavaScript SDK Overview"
description: "The ChainPatrol JavaScript SDK provides ThreatDetector, Relay, Storage, and API client tools to protect your app's users from phishing and scam URLs."
---

**Phishing** and **scam URLs** are a huge problem online.
To make it easier for wallet, dApp, and other security-conscious app builders to
protect their users from these threats, we've built a JavaScript SDK that you can use to
...
export const typescriptIcon = <svg
        viewBox="0 0 128 128"
        fill="none"
