---
title: Overview
description: The ChainPatrol JavaScript SDK provides ThreatDetector, Relay, Storage, and API client tools to protect wallets, dApps, and other security-conscious apps from phishing and scam URLs.
---
