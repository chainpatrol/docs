---
title: "ThreatDetector Constructor"
description: Instantiate a new ThreatDetector with local or cloud mode, an API key, storage adapter, proxy URL, and custom redirect URL for scam URL detection.
---
