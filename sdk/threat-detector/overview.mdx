---
title: Overview
description: The ThreatDetector class wraps ChainPatrol's phishing and scam detection APIs with caching, storage adapters, and URL checks for dApps and wallets.
---
