---
title: "ThreatDetector Class Overview"
description: "The ThreatDetector class wraps ChainPatrol's phishing and scam detection APIs with caching, storage adapters, and URL checks for security-conscious apps."
---

A [ThreatDetector](./constructor) allows you to easily build out community safety features
in your wallet, dApp, or other security-conscious app. It is a smart wrapper around ChainPatrol's APIs that allows you to
