---
title: Quickstart
description: Install the ChainPatrol JavaScript SDK and wire up ThreatDetector, Storage, and Relay to add phishing URL checks to your wallet or browser extension.
---
