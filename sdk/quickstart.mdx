---
title: Quickstart
description: Install the ChainPatrol JavaScript SDK and wire up ThreatDetector, Storage, and Relay to add phishing URL checks to your wallet, banking app, or browser extension.
---
