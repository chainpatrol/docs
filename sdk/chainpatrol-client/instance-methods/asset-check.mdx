---
title: "asset.check"
description: Check the real-time threat status of a single URL, page, social profile, or blockchain address with the ChainPatrol JavaScript SDK's asset.check API method.
---
