...
| `FARCASTER_CHANNEL_NOT_REPORTABLE` | Asset is a Farcaster channel URL (e.g. `farcaster.xyz/~/channel/…`) | Report the Farcaster profile behind the scam instead |
...
**"FARCASTER_CHANNEL_NOT_REPORTABLE" errors:**

Farcaster does not action takedown requests for channels

Report the Farcaster profile behind the scam instead (`farcaster.xyz/username`)

Farcaster profiles, casts, and mini apps remain reportable
