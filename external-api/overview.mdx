...
description: "Index of every ChainPatrol External API endpoint for wallets, banking and fintech apps, security apps, and marketplaces to check, submit, and monitor scam URLs and addresses."
---

We work with leading wallets, banking and fintech apps, and security platforms to block scam
links, contract addresses, and wallet addresses before a user interacts with the scam.
ChainPatrol's APIs are offered as a free service to wallets, banking and fintech apps,
security apps, and marketplaces.
