...
<CardGroup cols={2}>
  ...
  <Card title="Creating Reports" icon="book-open" href="/external-api/creating-reports">
    Guide to the whole reporting flow, including uploading evidence files.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Creating Reports" icon="book-open" href="/external-api/creating-reports">
    Step-by-step guide to filing a report, with evidence files attached.
  </Card>
  ...
  <Card title="Upload Attachment" icon="paperclip" href="/external-api/attachment-upload">
    Upload evidence files (`.eml`, screenshots, PDFs) and get a URL to attach to a report.
  </Card>
