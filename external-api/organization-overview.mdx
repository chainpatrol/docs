...
Access your organization's security reports:

<Card title="List Reports" icon="file-lines" href="/external-api/organization-reports-list">
  Retrieve security reports for your organization with filtering and pagination
</Card>

### Metrics

Track your organization's security metrics and analytics:

<Card title="Get Metrics" icon="chart-line" href="/external-api/organization-metrics-list">
  Get comprehensive threat detection and blocking metrics with time series data and optional brand filtering
</Card>
...
- 💬 Contact support@chainpatrol.io
- 🐛 Report issues through your organization dashboard
