...
<Card title="List Reports" icon="file-lines" href="/external-api/organization-reports-rest">
...
<Card title="Get Metrics" icon="chart-line" href="/external-api/organization-metrics-rest">
  Get comprehensive threat detection and blocking metrics
</Card>
