...
<Note>
  Agents that speak MCP do not have to shell out to the CLI at all: `chainpatrol mcp`
  serves every public API operation as MCP tools, locally or over HTTP. See the [MCP
  server](/cli/mcp).
</Note>
