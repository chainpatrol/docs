...
sidebarTitle: orgs
icon: building
description: "List and inspect ChainPatrol organizations. Filter by subscription status, service toggles, and pending approvals, and view an org's allowlist and brands."
---
...
| `--pending-approval-service <l>` | Only organizations with a pending approval for `protection` (Blocklisting) and/or `takedowns`. |
