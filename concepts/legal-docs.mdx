...
- **Secure Handling** - Stored and accessed with encryption and strict controls
- **Used When Needed** - Applied only during submission process
- **Keep Current** - Up-to-date documents are critical for successful takedown requests
