...
- **Takedowns In Progress** - Takedowns currently being worked, counted by their last update in the selected period
- **Takedowns Completed** - How many takedown requests have been successfully resolved
- **Takedowns Cancelled** - Takedowns currently cancelled, counted by their last update in the selected period
