...
Custom date ranges picked in the Date Range picker are day-granular and interpreted as whole UTC calendar days, with the end day included in full. For example, "Jul 1 – Jul 31" covers all of July in UTC, from July 1 00:00 UTC through the end of July 31 UTC. Because list pages and CSV exports use the same UTC-day interpretation, dashboard numbers reconcile with them. If you need a window smaller than a full day, use the quick-select presets (e.g., "Last 24 hours").
...
- **Submitted Assets** - How many individual assets were submitted across all reports in the selected period. One report containing three assets contributes three to this count. Shown in the General Summary next to Reports and included in the summary CSV export. Like the Reports metric, brand filters do not apply to this count.
