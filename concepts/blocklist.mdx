---
title: "The ChainPatrol Blocklist"
description: "How ChainPatrol's blocklist confirms and distributes phishing sites, scam accounts, and malicious addresses to browsers, DNS providers, and wallets."
---
...
- **Threat intelligence partnerships** with organizations like Google Safe Browsing, VirusTotal, Quad9, SEAL-ISAC, and Crypto-ISAC (Cryptocurrency Information Sharing and Analysis Center)
- **Manual verification** by security experts

<Note>ChainPatrol shares threat data bidirectionally with partners including Google Safe Browsing, VirusTotal, and Quad9, which query and contribute to our blocklist for browser- and DNS-level protection. Crypto-ISAC is a similar bidirectional partnership focused specifically on the cryptocurrency ecosystem, enabling faster detection and blocking of malicious domains for crypto brands.</Note>
...
Organizations using ChainPatrol for brand protection — across Fintech, Banking, Crypto, iGaming, VC, and more — contribute threat intelligence from their own detection systems. Partners like Google Safe Browsing, VirusTotal, and Quad9 share detected threats through bidirectional integrations, as do security alliances including SEAL-ISAC and Crypto-ISAC. Wallet providers like MetaMask, Phantom, and Coinbase Wallet, and blockchain projects and DAOs monitoring for impersonation attacks, contribute as well.
...
Google Safe Browsing powers protection in Chrome, Safari, Edge, Firefox, and other browsers. Quad9 and Cloudflare Gateway provide DNS- and network-level protection for enterprises. Blocklisted URLs are prevented from loading or show warning pages, protecting users regardless of which website they're visiting.
...
Applications across every industry integrate our blocklist directly — browser blocklists, company firewalls, and antivirus tools filter malicious content automatically, while platform-specific integrations like Polymarket (content moderation and user protection), Snapshot (governance platform security), NFT marketplaces (filtering scam collections and malicious listings), and DeFi protocols (protecting users from fake interfaces and phishing sites) warn users about threats specific to their platform. Fintech, banking, and iGaming applications integrate the same way to filter malicious content and warn their users.

### Threat Intelligence

VirusTotal, SEAL-ISAC, Crypto-ISAC, Eth-Phishing-Detect (ChainPatrol is a core contributor), and Polkadot Phishing List for cross-chain threat sharing. Our blocklist feeds into the broader security ecosystem, creating a network effect where threats are shared across organizations and platforms.
