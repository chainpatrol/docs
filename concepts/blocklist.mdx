---
title: "Blocklist"
description: "How ChainPatrol's blocklist confirms and distributes phishing sites, scam accounts, and malicious wallet addresses to browsers, wallets, and partners"
---

## Overview

A blocklist (also known as a denylist) is a database of confirmed malicious entities that should be blocked or flagged to protect users. In the context of online security, a blocklist contains verified phishing websites, scam social media accounts, fraudulent crypto addresses, and other malicious digital assets.
...
- **Threat intelligence partnerships** with organizations like Crypto-ISAC (Cryptocurrency Information Sharing and Analysis Center)
- **Manual verification** by security experts

<Note>Through our partnership with Crypto-ISAC, ChainPatrol participates in bidirectional threat intelligence sharing, enabling faster detection and blocking of malicious domains across the cryptocurrency ecosystem.</Note>

## Threat Intelligence Sharing

ChainPatrol collaborates with security partners including Blockaid and Hypernative to share threat intelligence and blocklist data. This partnership approach ensures that phishing domains and wallet drainer threats are blocked across multiple security systems, providing broader protection for users throughout the ecosystem.

<Info>These partnerships are complementary, meaning ChainPatrol works alongside these companies rather than competing with them, creating a unified defense against common threats.</Info>
...
SEAL-ISAC, Crypto-ISAC, Blockaid, Hypernative, Eth-Phishing-Detect (ChainPatrol is a core contributor), and Polkadot Phishing List for cross-chain threat sharing. Our blocklist feeds into the broader security ecosystem, creating a network effect where threats are shared across organizations and platforms.
