...
ChainPatrol staff can attribute a report to a named **threat actor**, the group or campaign operator behind the reported assets. Attribution helps you see when separate reports trace back to the same adversary.
