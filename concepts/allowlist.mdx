---
title: "Allowlist"
description: "How ChainPatrol tracks trusted brand-owned domains, wallets, and social accounts to reduce false positives and serve as a baseline for phishing detection"
---
...
ChainPatrol can automatically identify legitimate assets through integrations — for example, the [Vercel integration](/docs/integration/vercel) confirms which Vercel deployments belong to your organization, reducing false positives and speeding up the review process.
...
**Official Blockchain Assets (crypto-specific)** - Official smart contracts, treasury wallets, multisig addresses, token contracts. Example: `0x1234...` (official token contract)
