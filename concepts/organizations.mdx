---
title: "Organizations"
description: "How organizations in ChainPatrol group brands, assets, team members, and services like detection, reviewing, takedowns, and blocklisting in one workspace"
---
...
Adds approved threats to ChainPatrol's global blocklist, which is distributed to browsers, DNS providers, antivirus tools, partner wallets like Coinbase Wallet and MetaMask, and other partner platforms to protect users from known malicious assets in real time.
...
Lets owners and admins search leaked credentials against the brands you allowlist, using the email assets you already track. Results are live lookups with passwords masked until you reveal them. A daily Slack alert fires when leak volume for a monitored domain increases. This service is optional and independent of Detection and Takedowns. See [Dark Web Monitoring](/concepts/dark-web-monitoring).
...
<Warning>
This permission system ensures that potentially destructive actions (like turning on Blocklisting or Automated Takedowns) only happen with your organization's explicit permission.
</Warning>
