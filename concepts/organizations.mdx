---
title: "Organizations"
description: "How organizations in ChainPatrol group brands, assets, team members, and services like detection, reviewing, takedowns, and wallet blocking in one workspace"
---
...
- **Wallet Addresses** - Blockchain addresses and contracts (crypto-specific)
...
Allows approved crypto-related threats to be added to ChainPatrol's global blocklist, which is distributed to partner wallets like Coinbase Wallet and MetaMask, alongside browsers, DNS providers, and other partner platforms, to protect users from known malicious addresses. Most impactful for organizations with a wallet or crypto presence, though the underlying blocklist protects across wallets, browsers, and other platforms for every organization.
