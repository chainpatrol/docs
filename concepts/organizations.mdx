...
Optional. Lets owners and admins search dark web leak data for allowlisted brands, covering email domains, email addresses, and crypto wallet addresses. See [Dark Web Monitoring](/concepts/dark-web-monitoring).
