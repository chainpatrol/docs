...
- **Middle Ground** - Watchlist is for assets between blocking and allowing
- **Two Main Purposes** - Inconclusive evidence and takedown monitoring
- **Adaptive Monitoring** - Scan frequency adjusts based on time and status
- **Automatic for Takedowns** - All takedown assets are automatically watchlisted
- **Manual for Review** - Analysts can watchlist during inconclusive reviews
- **Multiple Exit Paths** - Assets leave watchlist when status becomes clear
- **Time-Based Decay** - Long-term uncertain assets are eventually removed
- **Continuous Scanning** - Regular checks detect changes and completion
