...
sidebarTitle: Slack
description: Install the ChainPatrol Slack bot to submit scam reports via slash commands and receive real-time threat notifications and blocklist alerts in Slack.
---
...
Once the bot is added to your workspace, you can use the following actions:
