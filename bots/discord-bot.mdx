...
description: The ChainPatrol Discord bot lets server members submit scam reports, auto-monitors links against our blocklist, and streams threats to a reports feed.
---
