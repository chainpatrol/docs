...
<Tip>
  Check out the [common issues section](/bots/discord-bot#common-issues) below
...
Bot role not high enough to see channels (needed to be able to read and write ephemeral messages)
![Success of the ChainPatrol Discord bot](/images/discord-bot-success.png)

Slash commands not visible to Discord members

Embed links permission required for reports feed
