...
description: "Overview of common crypto phishing attack vectors including wallet drainers, seed phrase theft, social engineering, malware, and developer key compromise."
---
...
This includes passwords, credit card numbers, or even a user's two factor authentication codes. Common attack vectors aim to steal a user's seed phrase for their wallet, or simply all of the contents of their wallets.
