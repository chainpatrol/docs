---
title: "How the Blocklist Works"
description: "Continuously updated database of confirmed phishing sites and malicious assets, distributed to browsers, wallets, and security platforms in real time."
---

## Overview

ChainPatrol's Blocklist is a real-time, community-powered database of confirmed phishing sites, scams, and malicious assets that protects users of brands across Fintech, Banking, Crypto, iGaming, VC, and more.

The ChainPatrol Blocklist is a continuously updated list of hundreds of thousands of malicious websites, social media accounts, crypto addresses, and other digital assets that have been verified as threats. This comprehensive database is powered by multiple sources:

- **Community Reports**: User submissions and reports from our partner organizations
- **Automated Detection**: AI-powered monitoring systems that scan the internet for new threats
- **Threat Intelligence Partnerships**: Bidirectional sharing with organizations such as Crypto-ISAC (Cryptocurrency Information Sharing and Analysis Center) and other industry information-sharing networks to enhance protection across sectors
- **Manual Review**: Expert analysis and verification of reported assets

<Note>Our partnership with Crypto-ISAC is one of several threat intelligence partnerships that enable real-time sharing of malicious domains and other indicators, helping to protect users across multiple platforms and industries, including the crypto space.</Note>
...
For brands with a crypto or wallet presence, major integrations include:
...
When an asset is blocklisted, it's automatically distributed to multiple platforms. Today, our distribution network is primarily focused on **domains and URLs** — these are the asset types that flow through to browsers, wallets, DNS providers, and threat intelligence partners.

- **Google Safe Browsing** - Domains and URLs for browser protection
- **SEAL-ISAC** - URLs hosted on 50+ hosting providers (Vercel, Cloudflare, AWS, etc.)
- **Crypto-ISAC** - URL and domain assets
...
Social media accounts, blockchain addresses, and other asset types are tracked and blocklisted in our database, and available via our API. Automated distribution for these asset types to external platforms is being expanded over time.

Distribution for domains and URLs happens automatically through our integration workflows. There's no manual step required.
...
- **Browser, Wallet & DNS Blocking** - Block access at the browser, wallet, and DNS level
...
- Blocklist provides immediate protection while takedowns are processed: Users are protected within minutes via browser, wallet, and security-platform integrations, even as takedown requests work through slower provider channels
...
- Public API enables broad protection: Making the blocklist freely accessible means any browser, wallet, or security tool can integrate and protect their users, regardless of industry