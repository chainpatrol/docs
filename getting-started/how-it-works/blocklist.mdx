---
title: "Blocklist"
description: "Continuously updated database of confirmed phishing sites and malicious assets, distributed to wallets and browsers for real-time crypto protection."
---

## Overview

ChainPatrol's Blocklist is a real-time, community-powered database of confirmed phishing sites, scams, and malicious assets that protects users across the ecosystem.
...
- **Threat Intelligence Partnerships**: Bidirectional sharing with organizations like Crypto-ISAC (Cryptocurrency Information Sharing and Analysis Center) to enhance protection across the cryptocurrency ecosystem
- **Manual Review**: Expert analysis and verification of reported assets

<Note>Our partnership with Crypto-ISAC enables real-time sharing of threat intelligence and malicious domains, helping to protect users across multiple platforms and organizations in the crypto space.</Note>
...
ChainPatrol shares blocklist data with trusted security partners including Blockaid and Hypernative to maximize protection across the ecosystem. This collaborative approach means that when ChainPatrol identifies a phishing domain or wallet drainer, the threat intelligence is shared with complementary security systems to block the same threats across multiple touchpoints.

<Info>These partnerships enhance the overall security posture of the web3 ecosystem by ensuring threats are blocked not just in ChainPatrol-protected systems, but across a network of security solutions.</Info>
