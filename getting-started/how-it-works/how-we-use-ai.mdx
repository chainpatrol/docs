---
title: "How We Use AI"
description: "How ChainPatrol's AI combines content, visual, and behavioral analysis to detect phishing and impersonation threats in seconds across 50+ platforms."
---
...
**Social & Communication:** Discord, Twitter/X, Telegram, LinkedIn, YouTube, Reddit, TikTok, Instagram, Threads, Medium, WhatsApp, Facebook, Snapchat, Substack, Tumblr
...
When our AI detects a threat, it doesn't just sit in a database. We push it directly to the platforms and security tools your users rely on — browsers, wallets, and other integrated security platforms, depending on where your brand's users are:
...
For brands with a crypto or wallet presence, direct integrations with leading wallets provide an additional layer of real-time warnings at the point of transaction:
...
- **20+ More Wallets** - Comprehensive wallet coverage


**The result:** Threats detected by ChainPatrol are blocked across every integrated platform within seconds.
