...
2. **Platform Scanning** - The source searches its platform (ex. X, Google Ads, Reddit) using your organization's keywords and monitoring rules
...
**X Monitoring:**
- **X Monitoring** - Enhanced scanning capabilities through our Enterprise agreement enable comprehensive monitoring and faster response times for direct impersonation threats
- X Post Search - Searches X posts for threats
- X User Search - Monitors X user profiles
- X Profile Monitoring - Tracks replies on posts from specific X profiles
...
- **Add Official Assets** - Add official X assets to monitor replies
