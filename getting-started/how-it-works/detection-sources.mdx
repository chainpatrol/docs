...
**LinkedIn Monitoring:**
- **LinkedIn** - ChainPatrol’s automated LinkedIn detection protects your brand from impersonation by monitoring both employee profiles and posts.

**Automated Employee Protection**
Any LinkedIn profile claiming to be associated with your organization is automatically checked against your allowlist. If the profile is not whitelisted, it is immediately flagged and reported for takedown—no manual reporting required.

**Automated Post Monitoring**
LinkedIn posts are automatically scanned using a combination of hiring‑related keywords (e.g., “we are hiring”, “job opportunity”) and general threat keywords to identify scams such as fake job offers and phishing links. Detections are surfaced in real‑time.
