...
- Detection sources continuously scan specific platforms and data streams for threats
- Sources run on schedules and submit discovered assets into the analysis pipeline
- Coverage spans search engines, social platforms, app stores, and Web3 surfaces
- Configuration controls status, scope, and schedule (including custom schedules)
- Best results come from good included/excluded terms and iterative tuning
