---
title: "Detection sources: automated brand threat monitors"
description: "Automated monitors that scan search engines, social media, app stores, and blockchain feeds to surface impersonation and phishing threats to your brand."
---
...
<Info>
ChainPatrol supports **39 different detection sources** across multiple categories
</Info>
...
- **X (formerly Twitter)** - Enhanced scanning capabilities through our Enterprise agreement enable comprehensive monitoring and faster response times for direct impersonation threats
...
- Twitter People Discovery - Discovers public X/Twitter profiles that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)
...
- Telegram Channel Discovery - Discovers public Telegram channels and groups via the Vetric API (enabled by default for top-priority organizations)
- Telegram User Discovery - Discovers public Telegram users and bots via the Vetric API (enabled by default for top-priority organizations)

**Facebook Monitoring:**
- Facebook Page Discovery - Discovers public Facebook pages that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)

**Instagram Monitoring:**
- Instagram Account Discovery - Discovers public Instagram accounts that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)

**Meta Ads Monitoring:**
- Meta Ads Discovery - Discovers ads in the Meta Ad Library that may impersonate the brand across Facebook and Instagram via the Vetric API (enabled by default for top-priority organizations)

**TikTok Monitoring:**
- TikTok Video Search - Searches TikTok videos
- TikTok User Search - Searches TikTok user profiles
- TikTok User Discovery - Discovers public TikTok accounts that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)
- TikTok Post Discovery - Discovers TikTok posts matching brand keywords that may be malicious via the Vetric API (enabled by default for top-priority organizations)

**LinkedIn Monitoring:**
- LinkedIn Company Search - Searches LinkedIn company pages for brand impersonation (disabled by default; enable per organization)
- LinkedIn Company Discovery - Discovers public LinkedIn company pages that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)
- LinkedIn People Discovery - Discovers public LinkedIn profiles that may impersonate the brand via the Vetric API (enabled by default for top-priority organizations)

<Info>
Our enhanced X platform integration allows for more thorough detection of social media-based threats and expedited takedown processing.
</Info>
