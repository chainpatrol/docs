...
description: Submit links through the ChainPatrol API to run them against our threat engine and automatically create reports for suspected phishing or impersonation.
---
...
Make a call to the [Asset-Submit API](https://chainpatrol.com/docs/external-api/asset-submit) with a list of the links that you want checked.
